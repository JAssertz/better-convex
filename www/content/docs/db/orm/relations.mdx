...
**Category**: ✅ 100% Compatible (Definition) | ⚠️ Coming Soon (Loading with `with:`)
...
**🚀 Convex Advantage**: Many-to-many relations use edge-based join tables, automatically indexed for fast traversal.
</Callout>
