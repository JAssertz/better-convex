...
5. Need advanced pre-pagination composition (union/interleave/map/filter/flatMap/distinct)? Use the `select()` composition chain.
...
<Cards>
  ...
  <Card title="Triggers" href="/docs/server/components/triggers" />
