---
title: Quickstart
description: Get started with the ORM in 5 minutes
---
...
Create a small helper that attaches the ORM to `ctx.orm`. You only need to do this once in your context setup:
