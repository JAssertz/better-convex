...
Convex Ents is in maintenance mode. For new work or Drizzle‑style queries, see the
[migration guide](/docs/db/orm/migrate-from-ents).
</Callout>
...
<Cards>
  <Card title="Migrate to Better‑Convex ORM" href="/docs/db/orm/migrate-from-ents" />
