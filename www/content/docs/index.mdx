...
| Page | When to Use |
|------|-------------|
| [ORM](/docs/db/orm) | Drizzle-style schema, queries, mutations, RLS, runtime constraints via `ctx.orm`. |
| [Triggers](/docs/db/orm/triggers) | Automatic side effects on insert/update/delete with schema triggers. |
...
| [Migrations](/docs/migrations) | Migration hub with paths for Core, ORM, and Auth. |
...
1. [ORM](/docs/db/orm) → schema + queries via `ctx.orm`
2. [Triggers](/docs/db/orm/triggers) → automatic side effects
