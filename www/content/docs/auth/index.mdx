...
- **React hooks** - `useAuthStatus`, `useAuthGuard`, and conditional rendering
...
- **`useAuthStatus`** - Get auth loading/authenticated state
...
import { useAuthStatus, Authenticated, Unauthenticated } from 'better-convex/auth-client';
