...
│     useQuery(api.posts.list) → runs                                      │
│     useQuery(api.user.me)    → runs                                      │
...
<Step>Deploy your app to production</Step>
...
<Step>Generate and set JWKS</Step>
...
<Step>Verify authentication works</Step>
