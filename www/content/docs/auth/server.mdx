...
Register Better Auth HTTP routes in Convex:

```ts title="convex/functions/http.ts" showLineNumbers {2-3,7}
...
Add custom endpoints alongside auth routes - see [HTTP Router](/docs/server/http) for webhooks, CORS, and more.
