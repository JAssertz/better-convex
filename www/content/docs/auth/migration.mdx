...
<Callout icon={<InfoIcon />}>
**Not using cRPC?** Keep using `convexBetterAuthNextJs` from `@convex-dev/better-auth/nextjs`. The migration above covers everything you need.
</Callout>
...
For TanStack Start, follow Steps 1-7 above for core auth migration. This section covers framework-specific setup.
