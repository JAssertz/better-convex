...
Use `types: { date: true }` when your handlers run through cRPC and you want ORM `createdAt` values hydrated as `Date`. Without it, `createdAt` stays `number`.
...
<Cards>
  ...
  <Card title="Pagination" href="/docs/db/orm/queries/pagination" />
