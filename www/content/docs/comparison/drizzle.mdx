...
| `count/sum/avg/max/min` in query builder | Use components | Use [Aggregates](/docs/server/advanced/aggregates) (`@convex-dev/aggregate`) |
...
- Guide: [/docs/server/advanced/aggregates](/docs/server/advanced/aggregates)
